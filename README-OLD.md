...
The starter template for [Hugo Bootstrap Theme](https://github.com/VipinMadhaan/hugo-theme-bootstrap) that install the theme as a Hugo module.
...
```shell
$ git clone https://github.com/VipinMadhaan/hugo-theme-bootstrap-skeleton.git blog
$ cd blog
$ rm -rf .git
$ git init -b main
```
...
```text
module github.com/VipinMadhaan/hugo-theme-bootstrap-skeleton
```
...
```shell
$ hugo mod get github.com/VipinMadhaan/hugo-theme-bootstrap@master
$ hugo mod npm pack
$ npm update
...
You can also replace the `master` with stable [releases](https://github.com/VipinMadhaan/hugo-theme-bootstrap/releases).
...
This template supports GitHub Pages, Docker image, Netlify out-of-box.
